...
<a class="download-link" title="<?php if ( $dlm_download->get_version()->has_version_number() ) {
	...
	<?php echo strip_tags( get_the_term_list( $dlm_download->get_ID(), 'dlm_download_category', '<span class="terms dlm-download-category">', ', ', '</span>' ), '<span>' ); ?>
	<?php echo strip_tags( get_the_term_list( $dlm_download->get_ID(), 'marca', '<span class="terms marca font-weight-bold">', ', ', '</span>' ), '<span>' ); ?>
